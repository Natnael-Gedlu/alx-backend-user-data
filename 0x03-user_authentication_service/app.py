...
def index() -> str:
    ...
    Returns:
        str: JSON response {"message": "Bienvenue"}
    """
...
def logout():
    """
    Endpoint for user logout and session destruction.

    Returns:
        str: Redirect response to the root endpoint.
    """
...
def profile() -> str:
    """
    Endpoint for retrieving user profile based on session ID.

    Returns:
        str: JSON response with user's email or error message.
    """
...
def get_reset_password_token() -> str:
    """
    Endpoint for generating a reset password token.
